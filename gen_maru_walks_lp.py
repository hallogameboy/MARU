...
if __name__ == '__main__':
    ...
    #  Load graph data                      #
    #########################################
    num_nodes, num_edges, node_list, edges, node_type, type_idx = data_helpers.load_lp_dataset(cfg['path_data'], dataset)
    ...
    #  MARU walks                           #
    #########################################
    out_file = cfg['path_walks'] + 'maru_walks.lp.{}.L{}.W{}.S{}'.format(dataset, walk_len, window_size, num_walks_per_node)
